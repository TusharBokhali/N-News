...
export default function Breaking({newsList}:props) {
    ...
    const onViewableItemsChanged = ({
      ...
      if(viewableItems[0].index !==undefined && viewableItems[0].index !== null){
        setPagiIndex(viewableItems[0].index % newsList.length);
      }
    };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.slider}>
        ...
        /> 
        <Pagination items={newsList} scrollX={scrollX} paginationIndex={pagiIndex}/>
